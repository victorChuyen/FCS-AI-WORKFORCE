...
export const WORKER_STATUS_LABELS: Record<WorkerStatus, string> = {
  [WorkerStatus.NEW]: 'Lao động mới (C3)',
  [WorkerStatus.DUPLICATE]: 'Số trùng (C3.1)',
  [WorkerStatus.JUNK]: 'Số rác (C3.2)',
  [WorkerStatus.ASSIGNED_TO_SALE]: 'Chia cho Sale (L1)',
  [WorkerStatus.REFERENCE]: 'Tham khảo (L1.1)',
  [WorkerStatus.FOLLOW_UP]: 'Chăm sóc lại (L1.2)',
  [WorkerStatus.REJECTED]: 'Từ chối (L1.3)',
  ...
  [WorkerStatus.FAILED]: 'Trượt PV (L2.2)',
  [WorkerStatus.NO_SHOW]: 'Không đến PV (L2.3)',
  [WorkerStatus.WAITING_START]: 'Chờ đi làm',
  [WorkerStatus.WORKING]: 'Đang đi làm (L3)',
  [WorkerStatus.QUIT]: 'Nghỉ ngang (L3.1)',
  [WorkerStatus.TRANSFER_REQUEST]: 'Chuyển Cty (L3.2)',
  [WorkerStatus.FEE_EXPIRED]: 'Hết hạn phí (L4)',
...
export const WORKER_STATUS_COLORS: Record<WorkerStatus, { bg: string; text: string; border: string }> = {
  ...
  [WorkerStatus.DUPLICATE]: { bg: 'bg-rose-50', text: 'text-rose-700', border: 'border-rose-200' },
  [WorkerStatus.JUNK]: { bg: 'bg-slate-100', text: 'text-slate-600', border: 'border-slate-200' },
  [WorkerStatus.ASSIGNED_TO_SALE]: { bg: 'bg-indigo-50', text: 'text-indigo-700', border: 'border-indigo-200' },
  [WorkerStatus.REFERENCE]: { bg: 'bg-sky-50', text: 'text-sky-700', border: 'border-sky-200' },
  [WorkerStatus.FOLLOW_UP]: { bg: 'bg-amber-50', text: 'text-amber-700', border: 'border-amber-200' },
  [WorkerStatus.REJECTED]: { bg: 'bg-rose-50', text: 'text-rose-700', border: 'border-rose-200' },
  [WorkerStatus.UNREACHABLE]: { bg: 'bg-orange-50', text: 'text-orange-700', border: 'border-orange-200' },
  [WorkerStatus.OVERAGE]: { bg: 'bg-purple-50', text: 'text-purple-700', border: 'border-purple-200' },
  [WorkerStatus.CALLBACK]: { bg: 'bg-yellow-50', text: 'text-yellow-700', border: 'border-yellow-200' },
  [WorkerStatus.UNDERAGE]: { bg: 'bg-pink-50', text: 'text-pink-700', border: 'border-pink-200' },
  [WorkerStatus.INTERVIEW_PENDING]: { bg: 'bg-cyan-50', text: 'text-cyan-700', border: 'border-cyan-200' },
  ...
  [WorkerStatus.NO_SHOW]: { bg: 'bg-stone-100', text: 'text-stone-700', border: 'border-stone-200' },
  [WorkerStatus.WAITING_START]: { bg: 'bg-teal-50', text: 'text-teal-700', border: 'border-teal-200' },
  [WorkerStatus.WORKING]: { bg: 'bg-emerald-50', text: 'text-emerald-800', border: 'border-emerald-200' },
  [WorkerStatus.QUIT]: { bg: 'bg-red-50', text: 'text-red-700', border: 'border-red-200' },
  [WorkerStatus.TRANSFER_REQUEST]: { bg: 'bg-violet-50', text: 'text-violet-700', border: 'border-violet-200' },
  [WorkerStatus.FEE_EXPIRED]: { bg: 'bg-zinc-100', text: 'text-zinc-700', border: 'border-zinc-300' },
